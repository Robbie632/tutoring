 ...
 *
 * Run the index.html file in the browser and step through the lines using the developer tools debugger
 */
...
// exercies: can you create an array of town names
// loop through the town names and render them to the screen
let townNamesList = document.getElementById("town-names");
// --- END OF FILE ---
